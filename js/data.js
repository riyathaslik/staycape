...
const localStore = {
    ...
    packages: [
        { id: 21, name: 'Munnar', type: 'domestic', price: 6000, nights: 3, days: 4, badge: 'Kerala Special', badge_class: 'green', featured: false, active: true, description: 'Rolling tea gardens and breathtaking scenic beauty in Kerala.' },
        { id: 19, name: 'Alappuzha', type: 'domestic', price: 9000, nights: 3, days: 4, badge: 'Kerala Special', badge_class: 'green', featured: false, active: true, description: 'The Venice of the East - houseboat rides and serene backwaters.' },
        { id: 20, name: 'Vagamon', type: 'domestic', price: 8000, nights: 2, days: 3, badge: '', badge_class: '', featured: false, active: true, description: 'Misty hill station with rolling meadows and pine forests.' },
        { id: 22, name: 'Ramakkalmedu', type: 'domestic', price: 5000, nights: 2, days: 3, badge: '', badge_class: '', featured: false, active: true, description: 'Hilltop vistas, wind turbines, and cool breezes - a hidden gem in Kerala.' },
        { id: 13, name: 'Kashmir', type: 'domestic', price: 12000, nights: 4, days: 5, badge: 'Trending', badge_class: 'blue', featured: true, active: true, description: 'Paradise on Earth - Dal Lake, Mughal gardens, and snow-capped peaks.' },
        { id: 12, name: 'Manali', type: 'domestic', price: 9000, nights: 3, days: 4, badge: 'Popular', badge_class: 'green', featured: true, active: true, description: 'Snow-capped peaks, roaring rivers, and apple orchards in the Himalayas.' },
        ...
        { id: 14, name: 'Spiti Valley', type: 'domestic', price: 18000, nights: 4, days: 5, badge: 'Adventure', badge_class: 'adventure', featured: false, active: true, description: 'The Cold Desert - high-altitude monasteries and surreal landscapes.' },
        { id: 10, name: 'Jaisalmer', type: 'domestic', price: 15000, nights: 3, days: 4, badge: '', badge_class: '', featured: false, active: true, description: 'The Golden City - desert dunes and the magnificent Jaisalmer Fort.' },
        { id: 23, name: 'Hampi', type: 'domestic', price: 7000, nights: 3, days: 4, badge: 'Heritage', badge_class: 'gold', featured: false, active: true, description: 'Ancient UNESCO heritage - boulder landscapes and magnificent temples.' },
        { id: 24, name: 'Goa', type: 'domestic', price: 8000, nights: 3, days: 4, badge: 'Popular', badge_class: 'green', featured: true, active: true, description: 'Sun, sand, and sea - beautiful beaches and Portuguese heritage.' },
        { id: 18, name: 'Hyderabad', type: 'domestic', price: 15000, nights: 4, days: 5, badge: '', badge_class: '', featured: false, active: true, description: 'The City of Pearls - Charminar, Golconda Fort, and world-famous biryani.' },
        { id: 9, name: 'Lakshadweep', type: 'domestic', price: 12000, nights: 4, days: 5, badge: 'Popular', badge_class: 'green', featured: true, active: true, description: 'India\'s hidden paradise - crystal lagoons and vibrant coral reefs.' },
        { id: 11, name: 'Agra & Delhi', type: 'domestic', price: 11000, nights: 3, days: 4, badge: '', badge_class: '', featured: false, active: true, description: 'The timeless Taj Mahal and the historic grandeur of India\'s capital.' },
        { id: 16, name: 'Meghalaya', type: 'domestic', price: 16000, nights: 3, days: 4, badge: '', badge_class: '', featured: false, active: true, description: 'The Abode of Clouds - living root bridges and thundering waterfalls.' },
